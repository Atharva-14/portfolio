        ...
        <div className="flex flex-row justify-between border-l-2 border-[#4F4F4F] pl-4">
          <div className="flex-1 space-y-6 text-center lg:text-left">
            <p className="text-gray-600 max-w-2xl mx-auto lg:mx-0 text-[1.5rem]">
              ...
              <span className="font-bold">3 years of experience</span> crafting
              fast, responsive, and accessible web applications.
            ...
            {/* CTA Buttons */}
            <div className="justify-center lg:justify-start gap-4 grid grid-cols-2">
